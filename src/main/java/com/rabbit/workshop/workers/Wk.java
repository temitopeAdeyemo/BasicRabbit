...
public class Wk {
    ...
    public static void init() throws Exception {
        ...
        channel.queueDeclare(QUEUE_NAME, durable, false, false, null); // We declare queue here incase the receiver/consumer is started before the publisher (Where the queue is declared) to avoid trying to read from a non-existence queue..
